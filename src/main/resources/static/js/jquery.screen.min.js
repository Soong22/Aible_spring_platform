            ...
            throw "제이쿼리가 없습니다.";
        {
            ...
            function _sortArray(e, t) {
                ...
                for (i = 0; i < r.length; i++)
                    r.hasOwnProperty(i) || (r.splice(i, 1), i--);
                return r
            }
            ...
            function _filterState(e) {
                var t = [];
                if ("string" == typeof e && (e = [e]), _$isArray(e)) {
                    var r = _settings.name;
                    t = _sortArray(_filterArray(_deduplicateArray(e), r).truth, r)
                }
                return t
            }
            function _setScreen() {
                ...
                r && (n += i),
                t && (a += i),
                _settings.hasHorizontalScrollbar = t,
                _settings.hasVerticalScrollbar = r,
            ...
            function _setState(e) {
                var t = _settings.state,
                    r = _filterArray(e, t),
                    i = r.untruth,
                    n = _filterArray(t, r.truth).untruth;
                return (i.length || n.length) && (_settings.state = e, console.log("상태 : " + e.join(", "))), {
                    activeState: i,
                    deactiveState: n
                }
            }
                ...
                if (options) {
                    ...
                    _$window.on("resize.screen", function(event) {
                        ...
                        var screenWidth = _settings.width,
                            ...
                            isChangedWidth = !1,
                            isChangedHeight = !1,
                            isTrigger = event instanceof _$Event && event.isTrigger;
                        screenWidth !== width && (width = screenWidth, isChangedWidth = !0),
                        screenHeight !== height && (height = screenHeight, isChangedHeight = !0),
                        isTrigger && (isChangedWidth = !1, isChangedHeight = !1),
                        ...
                        for (var i = 0, inStateLength = inState.length; i < inStateLength; i++) {
                            var value = inState[i];
                            isTrigger || (resizeState.push("resize:" + value), resizedState.push("resized:" + value)),
                        ...
                        timer = setTimeout(function() {
                            _setScreen(),
                            _settings.isChangedWidth = !1,
                            _settings.isChangedHeight = !1,
                            _event(resizedState)
                        }, 250)
            ...
            _$screen.setState = function(e) {
                var t = _filterState(e),
                    r = !1;
                if (t.length) {
                    var i = _setState(t),
                        n = i.activeState;
                    (n.length || i.deactiveState.length) && (_event(n), r = !0)
                }
                return r
            }
        }
