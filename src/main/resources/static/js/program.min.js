...
function getCalendar(objName, syear, smonth, str) {
    if (!objName)
        return void alert("getCalendar(document.bbsNttForm.start_date)와 같이 입력 필드 정보를 추가 하세요.");
    addWidget();
    var id,
        name;
    null != str && void 0 != str && "undefined" != str || (str = "Widget"),
    id = "l" + str,
    name = "w" + str;
    var win = document.getElementsByName(name)[0];
    with (objCal = objName, document.getElementById(id)) {
        if (removeActiveClass(objName), $(objName).hasClass(activeClass))
            return;
        ...
        style.left = left + "px",
        style.top = top + "px",
        null != syear && syear != undefined && "undefined" != syear || (syear = ""),
...
Dropdown.prototype.toggle = function(e) {
    ...
    if (dropdownClear(), options.position && !$parent.hasClass(options.position) && $parent.addClass(options.position), options.arrow && !$parent.hasClass("arrow") && $parent.addClass("arrow"), options.width) {
        ...
        options.width_target || (width_target = "p-dropdown__list"),
...
function(factory, jQuery, Zepto) {
    ...
    var Mask = function(el, mask, options) {
        var p = {
            ...
            events: function() {
                el.on("keydown.mask", function(e) {
                    ...
                    oldValue === p.val() || el.data("changed") || el.trigger("change"),
                    el.data("changed", !1)
                }).on("blur.mask", function() {
                    oldValue = p.val()
            ...
            getRegexMask: function() {
                for (var translation, pattern, optional, recursive, oRecursive, r, maskChunks = [], i = 0; i < mask.length; i++)
                    ...
                    translation ? (pattern = translation.pattern.toString().replace(/.{1}$|^.{1}/g, ""), optional = translation.optional, recursive = translation.recursive, recursive ? (maskChunks.push(mask.charAt(i)), oRecursive = {
                        digit: mask.charAt(i),
                        pattern: pattern
            ...
            calculateCaretPosition: function() {
                ...
                if (oldVal !== newVal) {
                    var caretPosOld = el.data("mask-previus-caret-pos") || 0,
                        ...
                        i = 0;
                    for (i = caretPosNew; i < newValL && p.maskDigitPosMap[i]; i++)
                        maskDigitsAfterCaret++;
                    for (i = caretPosNew - 1; i >= 0 && p.maskDigitPosMap[i]; i--)
                        maskDigitsBeforeCaret++;
                    for (i = caretPosNew - 1; i >= 0; i--)
                        p.maskDigitPosMap[i] && maskDigitsBeforeCaretAll++;
                    for (i = caretPosOld - 1; i >= 0; i--)
                        p.maskDigitPosMapOld[i] && maskDigitsBeforeCaretAllOld++;
                    if (caretPosNew > oldValL)
                        caretPosNew = 10 * newValL;
                        ...
                        caretPosNew > caretPosOld && (caretPosNew += maskDigitsBeforeCaretAll - maskDigitsBeforeCaretAllOld, caretPosNew += maskDigitsAfterCaret)
                }
                return caretPosNew
            },
        ...
        jMask.init = function(onlyMask) {
            if (onlyMask = onlyMask || !1, options = options || {}, jMask.clearIfNotMatch = $.jMaskGlobals.clearIfNotMatch, jMask.byPassKeys = $.jMaskGlobals.byPassKeys, jMask.translation = $.extend({}, $.jMaskGlobals.translation, options.translation), jMask = $.extend(!0, {}, jMask, options), regexMask = p.getRegexMask(), onlyMask)
                p.events(),
                p.val(p.getMasked());
            else {
                options.placeholder && el.attr("placeholder", options.placeholder),
                el.data("mask") && el.attr("autocomplete", "off");
                ...
                maxlength && el.attr("maxlength", mask.length).data("mask-maxlength", !0),
                p.destroyEvents(),
                p.events();
                var caret = p.getCaret();
                p.val(p.getMasked()),
    ...
    var HTMLAttributes = function() {
            ...
            if (input.attr("data-mask-reverse") && (options.reverse = !0), input.attr("data-mask-clearifnotmatch") && (options.clearIfNotMatch = !0), "true" === input.attr("data-mask-selectonfocus") && (options.selectOnFocus = !0), notSameMaskObject(input, mask, options))
    ...
    $.applyDataMask = function(selector) {
        ...
        (selector instanceof $ ? selector : $(selector)).filter($.jMaskGlobals.dataMaskAttr).each(HTMLAttributes)
    };
    var globals = {
    ...
    globals.dataMask && $.applyDataMask(),
...
function(e, t, n) {
    ...
    function u(e, t, n) {
        ...
        for (var r in e)
            if (e[r] in t)
                return !1 === n ? e[r] : (a = t[e[r]], o(a, "function") ? c(a, n || t) : a);
        return !1
    }
    function d(e) {
    ...
    function p(t, n, o) {
        ...
        if ("getComputedStyle" in e) {
            ...
            a = !n && t.currentStyle && t.currentStyle[o];
        return a
    }
    function f() {
        var e = t.body;
    ...
    function v(e, t, a, r) {
        ...
        for (var d, p, f, y, v, g = ["modernizr", "tspan", "samp"]; !z.style && g.length;)
            d = !0,
            z.modElem = s(g.shift()),
    ...
    Modernizr.inputtypes = function(e) {
        for (var o, a, r, s = e.length, l = 0; s > l; l++)
            P.setAttribute("type", o = e[l]),
            r = "text" !== P.type && "style" in P,
            r && (P.value = "1)", P.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && P.style.WebkitAppearance !== n ? (b.appendChild(P), a = t.defaultView, r = a.getComputedStyle && "textfield" !== a.getComputedStyle(P, null).WebkitAppearance && 0 !== P.offsetHeight, b.removeChild(P)) : /^(search|tel)$/.test(o) || (r = /^(url|email)$/.test(o) ? P.checkValidity && !1 === P.checkValidity() : "1)" != P.value)),
            _[e[l]] = !!r;
        return _
    }(S);
        ...
        for (var l in C)
            if (C.hasOwnProperty(l)) {
                ...
                for (a = o(t.fn, "function") ? t.fn() : t.fn, r = 0; r < e.length; r++)
                    s = e[r],
                    i = s.split("."),
                    1 === i.length ? Modernizr[i[0]] = a : (!Modernizr[i[0]] || Modernizr[i[0]] instanceof Boolean || (Modernizr[i[0]] = new Boolean(Modernizr[i[0]])), Modernizr[i[0]][i[1]] = a),
                    w.push((a ? "" : "no-") + i.join("-"))
            }
    }(),
    function(e) {
...
var objCal,
    activeClass = "obj-active";
if (-1 == navigator.appVersion.indexOf("MSIE 8.")) {
    $(function() {
        function checkFileupload(option) {
            var $this = $(this),
                data = $this.data("upload"),
                options = "object" == typeof option && option;
            data || $this.data("upload", data = new fileupload(this, options)),
            "string" == typeof option && data[option]()
        }
        function checkAddInput(option) {
            var $this = $(this),
                data = $this.data("addinput"),
                options = "object" == typeof option && option;
            data || $this.data("addinput", data = new addFileInput(this, options)),
            "string" == typeof option && data[option]()
        }
        ...
        fileupload.prototype.change = function() {
            ...
            if (window.FileReader) {
                if (filename = this.filestrip($originalinput[0].files[0].name), $originalinput[0].files.length > 1)
                    var filelength = $originalinput[0].files.length - 1
            } else
                filename = $originalinput.val().split("/").pop().split("\\").pop();
            filelength && (filename = filename + " 외 " + filelength),
        ...
        fileupload.prototype.clear = function() {
            var $element = this.element,
                ...
                $showinput = $region.find(this.options.showfilename),
                $clearbtn = $region.find(this.clearselector);
            $originalinput.replaceWith($originalinput.val("").clone(!0)),
            $showinput.empty(),
...
$(function() {
    function checkAll(option) {
        var $this = $(this),
            ...
            options = "object" == typeof option && option;
        data && $this.data("select", data = new checkedall(this, options)),
        "string" == typeof option && data[option]()
    }
    ...
    checkedall.prototype.changeitem = function() {
        ...
        !1 === this.checkItem.prop("checked") && this.checkBtn.prop("checked", !1),
        this.checkedItem > 0 && this.checkedItem < this.checkItemNum ? (this.checkBtn.prop("checked", !1), this.targetStatus = !0) : this.checkedItem === this.checkItemNum ? (this.checkBtn.prop("checked", !0), this.targetStatus = !0) : (this.checkBtn.prop("checked", !1), this.targetStatus = !1),
...
function(factory) {
    ...
    function opts_from_el(el, prefix) {
        ...
        for (var key in data)
            prefix.test(key) && (inkey = key.replace(replace, re_lower), out[inkey] = data[key]);
        return out
    }
    ...
    var DateArray = function() {
        ...
        Datepicker = function(element, options) {
            ...
            this.component = !!this.element.hasClass("p-date__icon") && this.element,
            this.button && (this.component = !!this.button.hasClass("p-date__icon") && this.button),
            ...
            this._buildEvents(),
            this._attachEvents(),
            this.isInline ? this.picker.addClass("p-datepicker-inline").appendTo(this.element) : this.picker.addClass("p-datepicker__dropdown dropdown-menu"),
            this.o.rtl && this.picker.addClass("p-datepicker-rtl"),
    ...
    Datepicker.prototype = {
        ...
        _applyEvents: function(evs) {
            for (var el, ch, ev, i = 0; i < evs.length; i++)
                el = evs[i][0],
                2 === evs[i].length ? (ch = undefined, ev = evs[i][1]) : 3 === evs[i].length && (ch = evs[i][1], ev = evs[i][2]),
                el.on(ev, ch)
        },
        ...
        _trigger: function(event, altdate) {
            ...
            this.element.trigger({
                ...
                format: $.proxy(function(ix, format) {
                    0 === arguments.length ? (ix = this.dates.length - 1, format = this.o.format) : "string" == typeof ix && (format = ix, ix = this.dates.length - 1),
        ...
        place: function() {
            ...
            this.picker.removeClass("p-datepicker-orient-top p-datepicker-orient-bottom p-datepicker-orient-right p-datepicker-orient-left"),
        ...
        fillMonths: function() {
            for (var focused, localDate = this._utc_to_local(this.viewDate), html = "", i = 0; i < 12; i++)
        ...
        _fill_yearsView: function(selector, cssClass, factor, year, startYear, endYear, beforeFn) {
            for (var classes, tooltip, before, html = "", step = factor / 10, view = this.picker.find(selector), startVal = Math.floor(year / factor) * factor, endVal = startVal + 9 * step, focusedVal = Math.floor(this.viewDate.getFullYear() / step) * step, selected = $.map(this.dates, function(d) {
                ...
                beforeFn !== $.noop && (before = beforeFn(new Date(currVal, 0, 1)), before === undefined ? before = {} : "boolean" == typeof before ? before = {
                    enabled: before
                } : "string" == typeof before && (before = {
                    classes: before
                }), !1 === before.enabled && classes.push("disabled"), before.classes && (classes = classes.concat(before.classes.split(/\s+/))), before.tooltip && (tooltip = before.tooltip)),
                html += '<button type="button" class="' + classes.join(" ") + '"' + (tooltip ? ' title="' + tooltip + '"' : "") + ">" + currVal + "</button>";
            var titleText = "이동 없음";
            100 === step ? view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].yearCentury + " - " + endVal + dates[this.o.language].yearCentury).attr("title", titleText) : 10 === step ? (this.o.maxViewMode > 3 && (titleText = "100년단위 연도 선택 이동"), view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].yearCentury + " - " + endVal + dates[this.o.language].yearCentury).attr("title", titleText)) : (this.o.maxViewMode > 2 && (titleText = "10년단위 연도 선택 이동"), view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].year + " - " + endVal + dates[this.o.language].year).attr("title", titleText)),
            ...
            if (!isNaN(year) && !isNaN(month)) {
                ...
                for (var weekDay, clsName, html = []; prevMonth.valueOf() < nextMonth;) {
                    ...
                    this.o.beforeShowDay !== $.noop && (before = this.o.beforeShowDay(this._utc_to_local(prevMonth)), before === undefined ? before = {} : "boolean" == typeof before ? before = {
                        ...
                        classes: before
                    }), !1 === before.enabled && clsName.push("disabled"), before.classes && (clsName = clsName.concat(before.classes.split(/\s+/))), before.tooltip && (tooltip = before.tooltip), before.content && (content = before.content)),
                ...
                var monthsTitle = dates[this.o.language].monthsTitle || dates.en.monthsTitle || "Months",
                    months = this.picker.find(".p-datepicker-months").find(".p-datepicker-switch").text(this.o.maxViewMode < 2 ? monthsTitle + dates[this.o.language].year : year + dates[this.o.language].year).attr("title", "연도 선택 이동").end().find("tbody button").removeClass("active");
        ...
        click: function(e) {
            ...
            var target,
                ...
                year,
                month;
            if (target = $(e.target), target.hasClass("p-datepicker-switch") && this.viewMode !== this.o.maxViewMode && this.setViewMode(this.viewMode + 1), target.hasClass("today") && !target.hasClass("day")) {
                this.setViewMode(0),
            ...
            target.hasClass("close") && (this.hide(), this.isInput || this.component.focus()),
            target.hasClass("disabled") || (target.hasClass("month") || target.hasClass("year") || target.hasClass("decade") || target.hasClass("century")) && (this.viewDate.setUTCDate(1), day = 1, 1 === this.viewMode ? (month = target.parent().find("button").index(target), year = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(month)) : (month = 0, year = Number(target.text()), this.viewDate.setUTCFullYear(year)), this._trigger(DPGlobal.viewModes[this.viewMode - 1].e, this.viewDate), this.viewMode === this.o.minViewMode ? this._setDate(UTCDate(year, month, day)) : (this.setViewMode(this.viewMode - 1), this.fill())),
        ...
        dayCellClick: function(e) {
            ...
            this.o.updateViewDate && (date.getUTCFullYear() !== this.viewDate.getUTCFullYear() && this._trigger("changeYear", this.viewDate), date.getUTCMonth() !== this.viewDate.getUTCMonth() && this._trigger("changeMonth", this.viewDate)),
            this._setDate(date),
        ...
        moveAvailableDate: function(date, dir, fn) {
            do {
                if (date = this[fn](date, dir), !this.dateWithinRange(date))
                    return !1;
                fn = "moveDay"
        ...
        setViewMode: function(viewMode) {
            ...
            this.picker.children("div").hide().filter(".p-datepicker-" + DPGlobal.viewModes[this.viewMode].clsName).show(),
            this.updateNavArrows(),
    ...
    var datepickerPlugin = ($.fn.datepicker, function(option) {
        ...
        if (this.each(function() {
            ...
            if ($that = $this.closest(".p-date"), $this.parent().hasClass("p-datepicker__wrap") || $this.parents().hasClass("p-date__range") || $this.wrap("<div class='p-datepicker__wrap'></div>"), !data) {
                this.btn = !!$this.hasClass("p-date__icon") && $this.closest(".p-date")[0],
                ...
                $(this.group).hasClass("p-date__range") || opts.inputs ? ($.extend(opts, {
        ...
        DPGlobal = {
            ...
            parseDate: function(date, format, language, assumeNearby) {
                ...
                if (date instanceof Date)
                    return date;
                if ("string" == typeof format && (format = DPGlobal.parseFormat(format)), format.toValue)
                ...
                if (date in dateAliases && (date = dateAliases[date]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(date)) {
                    for (parts = date.match(/([\-+]\d+)([dmwy])/gi), date = new Date, i = 0; i < parts.length; i++)
                ...
                if (parts.length !== fparts.length && (fparts = $(fparts).filter(function(i, p) {
                    ...
                    for (i = 0; i < setters_order.length; i++)
                        (s = setters_order[i]) in parsed && !isNaN(parsed[s]) && (_date = new Date(date), setters_map[s](_date, parsed[s]), isNaN(_date) || (date = _date))
                }
                return date
            },
            formatDate: function(date, format, language) {
                if (!date)
                    return "";
                if ("string" == typeof format && (format = DPGlobal.parseFormat(format)), format.toDisplay)
    ...
    $(document).on("click.p-date__icon click.p-input.start click.p-input end", '[data-date="datepicker"] .p-date__icon', function(e) {
        var $this = $(this);
...
$(function() {
    function modalPlugin(option) {
        return this.each(function() {
            ...
            data || $this.data("modal", data = new Modal(btn, options)),
    ...
    function modalRemotePlugin(option) {
        var $this = $(this);
        if (!option.container)
            return void console.log("외부 파일을 넣을 컨텐이너가 없습니다.");
        $.ajax({
            type: "GET",
            url: option.remote,
            dataType: "text",
    ...
    Modal.prototype.show = function() {
        ...
        if (this.$button.trigger(e), !this.isShown) {
            ...
            this.setSize(),
            element.show();
            element.hasClass("fade") && element[0].offsetWidth,
    ...
    Modal.prototype.hide = function(e) {
        ...
        this.isShown && (this.isShown = !1, e && e.preventDefault(), element.hide().removeClass("active"), $(document.body).removeClass("modal__open"), $("html").removeClass("modal__open"), element.find(backdrop).remove(), modalbtn.trigger("focus"), this.escape(), this.$button.trigger("hidden.modal"), this.$button.removeData("modal"))
    },
    ...
    Modal.prototype.setSize = function(width, height) {
        ...
        modalWidth > $(window).width() && (modalWidth = $(window).width() - 50),
    ...
    $(document).on("click.modal", "[data-button='modal']", function(e) {
        ...
        var $this = $(this),
            option = $this.data();
        $this.attr("href");
        ($this.is("button") || $this.is("a")) && e.preventDefault(),
        option.remote && !$(option.target).hasClass("loaded") ? modalRemotePlugin.call($this, option) : modalPlugin.call($this, option, this)
    })
}),
$(function() {
    ...
    OpenWindow.prototype.init = function(element, options) {
        this.element = $(element),
        this.options = options,
        this.options.url ? this.href = this.options.url : this.href = this.element.attr("href");
        var setWindow,
            windowLeft,
            windowTop;
...
$(function() {
    ...
    $(".chart-circle").length && $('[data-progress="circle"]').each(function() {
...
$(function() {
    ...
    tab.prototype.show = function() {
        ...
        $this.parent("li").hasClass("active") || ($target = $(selector), $targetGroup = $(selector).parent().closest("div"), this.activate($this.closest("li"), $ul, "> .active", "nav"), this.activate($target, $targetGroup, ".active"))
    },
    tab.prototype.activate = function(element, container, cts, area) {
        ...
        $active.hasClass("p-tab__body--slide") ? ($active.stop().hide().removeClass("active").end(), element.stop().slideDown(500, function() {
            ...
            $(this).addClass("active")
        })) : ($active.removeClass("active").end(), element.addClass("active")),
        "nav" === area && ($active.find("a, button").attr("title", ""), element.find("a, button").attr("title", "선택됨")),
        "nav" !== area && ($active.attr("title", "숨김"), element.attr("title", "열림"))
    },
    $(document).on("click", "[data-button='tab']", function(e) {
        $(this).data("url") || (e.preventDefault(), $(this).each(function() {
            ...
            this.options.dropdown && Dropdown()
        }))
    })
}),
$(function() {
    ...
    Accordion.prototype.activate = function(element, display) {
        element.addClass("active"),
        display && (element.show(), element.attr("title", "열림"))
    },
    Accordion.prototype.disabled = function(element, display) {
        element.removeClass("active"),
        display && (element.hide(), element.attr("title", "숨김"))
    },
    ...
    $(document).on("click", "[data-accordion]", function(e) {
        ...
        $(this).each(function() {
            var $this = $(this),
                ...
                options = $this.data();
            data || $this.data("accordion", data = new Accordion(this, "show", options)),
            data.show(),
            this.options = $this.data()
        })
    })
...
$(function() {
    ...
    tableElement.prototype.getWrap = function(classname) {
        var addClassTarget,
            wrapElement = this.element,
            wrapClassName = classname;
        wrapClassName || (wrapClassName = this.options.addwrapclass),
        addClassTarget = wrapElement.closest("." + wrapClassName),
        addClassTarget[0] || wrapElement.wrap("<div class='" + wrapClassName + "' />")
    },
    ...
    tableElement.prototype.bounceIcon = function() {
        addClassTarget = this.element.closest("." + this.options.addwrapclass),
        this.options.scrollguide && addClassTarget.removeClass("bouncein").addClass("bounceout")
    },
    ...
    -1 === navigator.appVersion.indexOf("MSIE 8.") && $(window).on("load", function(e) {
...
$(function() {
    ...
    Tooltip.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            $tip.detach().css({
                ...
                left: 0,
                display: "block"
            }).addClass(placement).data(this.type, this),
    ...
    Tooltip.prototype.hide = function(callback) {
        ...
        if (this.$element.trigger(e), !e.isDefaultPrevented())
            return $tip.removeClass("active"), function() {
                "in" !== that.hoverState && $tip.detach(),
                that.$element.removeAttr("aria-describedby").trigger("hidden." + that.type),
                callback && callback()
    ...
    Tooltip.prototype.toggle = function(e) {
        var self = this;
        e && ((self = $(e.currentTarget).data(this.type)) || (self = new this.constructor(e.currentTarget), $(e.currentTarget).data(this.type, self))),
        self.tip().hasClass("active") ? self.leave(self) : self.enter(self)
    },
