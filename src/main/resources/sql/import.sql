...
INSERT INTO board (
    view_count, board_id, created_at, member_id, updated_at, title, content, status
      ...
      (11, 1, '2024-12-01 10:00:00.000000', 1, NULL, '오래된 작성', '이 글은 한참 전에 작성되었습니다.', 'PENDING'),
      -- 몇 시간 전 작성일 (3시간 전)
      ...
      -- 한참 지난 작성일 (2024-12-01)
      (14, 4, NOW(), 4, NULL, '오래된 작성', '이 글은 한참 전에 작성되었습니다.', 'PENDING'),
      -- 몇 시간 전 작성일 (3시간 전)
      ...
      -- 한참 지난 작성일 (2024-12-01)
      (20, 10, NOW(), 5, NULL, '테스트4', '테스트4로 작성되었습니다.', 'PENDING'),
      -- 몇 시간 전 작성일 (3시간 전)
