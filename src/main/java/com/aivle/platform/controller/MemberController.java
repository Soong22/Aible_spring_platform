...
public class MemberController {
    ...
    // 마이페이지 - 내 정보 조회 GET
    @GetMapping("/mypage")
    public String getMypage(Model model, Authentication authentication, RedirectAttributes redirectAttributes) {
        try {
            MemberService.addMemberInfoToModel(model, authentication);
    ...
    public String editMypageForm(Model model, Authentication authentication, RedirectAttributes redirectAttributes) {
        try {
            MemberService.addMemberInfoToModel(model, authentication);
